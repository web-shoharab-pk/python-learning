...
# Writing to a file
file = open("file/write.txt", "w") # If the file does not exist, it will be created
file.write("I want to become a good programmer")
file.close()

# Appending to a file
file = open("file/write.txt", "a")
...
with open("file/write.txt", "r") as file:
    data = file.read()
    words = data.split()
...
with open("file/write.txt", "r") as file:
    ...
    with open("file/write.txt", "w") as file:
        file.write(data)
...
def print_even_numbers():
    with open("file/number.txt", "r") as file:
        data = file.read()
        numbers = data.split(", ")
        count_even = 0
